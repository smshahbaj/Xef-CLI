...
func newSHA256Cmd(hasher interfaces.Hasher, _ logger.Logger) *cobra.Command {
...
func newSHA512Cmd(hasher interfaces.Hasher, _ logger.Logger) *cobra.Command {
	return &cobra.Command{
...
func newBCryptCmd(hasher interfaces.Hasher, _ logger.Logger) *cobra.Command {
	var cost int
	var compare string
...
func newUUIDCmd(_ logger.Logger) *cobra.Command {
	var count int
	var upper bool
...
func newBase64Cmd(_ logger.Logger) *cobra.Command {
	var decode bool
...
func newPasswordCmd(_ logger.Logger) *cobra.Command {
	var length int
	var noSpecial bool
	var noNumbers bool
	var noUpper bool
